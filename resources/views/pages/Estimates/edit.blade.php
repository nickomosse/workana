...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('estimates.update', $estimate->id) }}" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comment" rows="5">{{$estimate->comment}}</textarea>
